...
/**
 * Klasa umożliwia zarządzanie numerami wersji oprogramowania. Klasa projektowana na podstawie
...
public class Version implements Comparable<Version> {
    ...
    /**
     * @return identyfikatory przedpremierowe - gdy jest to wersja przedpremierowa, null - gdy wersja stabilna
     */
    ...
    /**
     * @return główna liczba, wskazuje na ciągłość idei i podejścia, które gwarantuje kompatybilność rozszerzeń
     */
    public int getMajor() {
        return major;
    }
    ...
    /**
     * @return liczba podporządkowana, która definiuje ilość kompatybilnych rozszerzeń
     */
    public int getMinor() {
        return minor;
    }
    ...
    /**
     * Odczytuje wersję z klasy, która zawiera statyczną metodę {@code get()} zwracającą instancję klasy.
     * Wartości odczytywane są za pomocą wywołania metody {@link Object#toString()}.
     *
